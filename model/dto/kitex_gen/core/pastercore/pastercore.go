...
func serviceInfo() *kitex.ServiceInfo {
	return pasterCoreServiceInfo
}

var pasterCoreServiceInfo = newServiceInfo()

func newServiceInfo() *kitex.ServiceInfo {
	serviceName := "PasterCore"
	handlerType := (*core.PasterCore)(nil)
...
func getPostHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(core.PasterCore).GetPost(ctx, req)
		if err != nil {
			return err
		}
	...
	case *GetPostArgs:
		success, err := handler.(core.PasterCore).GetPost(ctx, s.Req)
		if err != nil {
			return err
		}
...
func savePostHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(core.PasterCore).SavePost(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *SavePostArgs:
		success, err := handler.(core.PasterCore).SavePost(ctx, s.Req)
		if err != nil {
			return err
		}
...
func deletePostHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(core.PasterCore).DeletePost(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *DeletePostArgs:
		success, err := handler.(core.PasterCore).DeletePost(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getCommentsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(core.PasterCore).GetComments(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetCommentsArgs:
		success, err := handler.(core.PasterCore).GetComments(ctx, s.Req)
		if err != nil {
			return err
		}
...
func saveCommentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(core.PasterCore).SaveComment(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *SaveCommentArgs:
		success, err := handler.(core.PasterCore).SaveComment(ctx, s.Req)
		if err != nil {
			return err
		}
...
func checkHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(core.PasterCore).Check(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CheckArgs:
		success, err := handler.(core.PasterCore).Check(ctx, s.Req)
		if err != nil {
			return err
		}
...
func watchHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	stream := &pasterCoreWatchServer{st}
	req := new(core.HealthCheckRequest)
	if err := st.RecvMsg(req); err != nil {
		return err
	}
	return handler.(core.PasterCore).Watch(req, stream)
}

type pasterCoreWatchClient struct {
	streaming.Stream
}

func (x *pasterCoreWatchClient) Recv() (*core.HealthCheckResponse, error) {
	m := new(core.HealthCheckResponse)
	return m, x.Stream.RecvMsg(m)
}

type pasterCoreWatchServer struct {
	streaming.Stream
}

func (x *pasterCoreWatchServer) Send(m *core.HealthCheckResponse) error {
...
func (p *kClient) Watch(ctx context.Context, req *core.HealthCheckRequest) (PasterCore_WatchClient, error) {
	...
	stream := &pasterCoreWatchClient{res.Stream}
